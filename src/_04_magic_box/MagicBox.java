...
public class MagicBox extends JPanel implements Runnable, MouseListener {
	 ...
	 */
	//So e.getX() and e.getY() will give you the x and y location of where your mouse clicked. then you
	//can have if statements to check if you clicked on that location
